...
public class AIXMGeometryFactory {
	...
	public static List<GeometryWithInterpolation> createCurve(CurvePropertyType curve) {
		...
		for (AbstractCurveSegmentType segment : curve.getCurve().getSegments().getAbstractCurveSegmentArray()) {
			if (segment instanceof LineStringSegmentType) {
				result.add(createLineString((LineStringSegmentType) segment, srs));
			}
			else if (segment instanceof GeodesicStringType) {
				result.add(createGreatCirlce((GeodesicStringType) segment, srs));
			}
			else {
	...
	private static GeometryWithInterpolation createGreatCirlce(GeodesicStringType segment, String srs) {
		LineString geom;
	...
	private static GeometryWithInterpolation createLineString(LineStringSegmentType segment, String srs) {
		LineString geom;
	...
	private static LinearRing createRing(AbstractRingType abstractRing, String srs) {
